...
| [dsh-webfetch](https://github.com/TYEclipse/dsh-webfetch) | Web page reader: fetch any URL as clean Markdown / plain text, inventory links, read RSS/Atom feeds, zero-dependency http proxy support — zero runtime dependencies, read-only | `dsh plugin --profile web add github:TYEclipse/dsh-webfetch#v0.2.0` | ✅ active | ✅ | ✅ e2e (web_fetch + web_feed) | 2026-08-22 | 62fdf85 |
